...
const ServicesModal = ({ show, handleClose, modalHeader }) => {
	...
	const modalBodyMaker = () => {
		switch (modalHeader) {
								...
								<div className="agency-services-box">
									<div className="col">
										<img
											...
											alt="Material Treatments - International Oilfield Supplies"
										/>
									</div>
								</div>
								<ul>
								...
								<div className="agency-services-box">
									<div className="col m-2">
										<img
											...
											alt="Logistics - International Oilfield Supplies"
										/>
									</div>
								</div>
								...
								<div className="agency-services-box">
									<div className="col m-2">
										<img
											...
											alt="Document Management - International Oilfield Supplies"
										/>
									</div>
								</div>
								<div className="d-flex flex-column justify-content-evenly align-items-center">
			...
			case "Inspection and Testing":
				return (
					<>
						<div className="d-flex flex-column">
							<p className="text-justify">
								IOS has established a system which ensures the final product is
			...
			// 					<p className="text-justify">
			// 						IOS has the capabilities to fabricate and spool large and
