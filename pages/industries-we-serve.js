					...
					<div className="row align-items-center">
						<div className="col-lg-6 services-details">
							<div className="services-details-desc">
								...
								<p className="text-justify">
									...
									makes IOS your ideal Partner. our experts have a wealth of
						...
						<div className="col-lg-6 services-details-image">
							<img
								...
								alt="Downstream and Midstream Industries - International Oilfield Supplies"
							/>
						</div>
					</div>
					...
					<div className="row align-items-center">
						<div className="col-lg-6 services-details-image">
							<img
								...
								width="100%"
								className="animate__animated animate__fadeInUp"
								alt="Upstream and Offshore Industries - International Oilfield Supplies"
							/>
						</div>
						...
						<div className="col-lg-6 services-details">
							<div className="services-details-desc">
								...
								<p className="text-justify">
									IOS provides its customers, with technical advice and high
					...
					<div className="row align-items-center">
						<div className="col-lg-6 services-details">
							<div className="services-details-desc">
								...
								<p className="text-justify">
									IOS has extensive experience in all differ- ent power
									segments. From Hydro power up to the biggest CCPP and lignite
									Fired Power stations, IOS is able to support its customers in
						...
						<div className="col-lg-6 services-details-image">
							<img
								...
								width="100%"
								className="animate__animated animate__fadeInUp"
								alt="Power Generation & Renewable Energy - International Oilfield Supplies"
							/>
						</div>
					</div>
					...
					<div className="row align-items-center">
						<div className="col-lg-6 services-details-image">
							<img
								...
								width="100%"
								className="animate__animated animate__fadeInUp"
								alt="Infrastructure, Building and Water Industry - International Oilfield Supplies"
							/>
						</div>
						...
						<div className="col-lg-6 services-details">
							<div className="services-details-desc">
								...
								<p className="text-justify">
									...
									materials. IOS has a strong position in this segment as well,
