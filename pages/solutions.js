					...
					<div className="row justify-content-center">
						...
						<div className="col-6">
							<div className="single-services-box">
								...
								<p className="text-justify">
									...
									thatmakes IOS your IDEAL PARTNER . Our experts have a wealth
						...
						<div className="col-6">
							<div className="single-services-box">
								...
								<p className="text-justify">
									IOS has extensive experience in all different power segments.
									From Hydro power up to the biggest CCPP and Lignite Fired
									Power stations, IOS is able tosupport its customers in every
									stage of demand.
								</p>
								<h3>
									<a>Product range & Services</a>
