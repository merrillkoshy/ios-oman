		...
		<>
			...
			<div className="main-text-area ptb-80">
				<div className="container">
					...
					<p>Welcome to International Oilfield Supplies - Piping The World!</p>

					<p>
						These terms and conditions outline the rules and regulations for the
						use of International Oilfield Supplies LLC's Website, located at
						https://www.iosgroupoman.com.
					</p>

					<p>
						By accessing this website we assume you accept these terms and
						conditions. Do not continue to use International Oilfield Supplies -
					...
					<p>
						We employ the use of cookies. By accessing International Oilfield
						Supplies - Piping The World, you agreed to use cookies in agreement
						with the International Oilfield Supplies LLC's Privacy Policy.{" "}
					</p>
					...
					<p>
						Unless otherwise stated, International Oilfield Supplies LLC and/or
						its licensors own the intellectual property rights for all material
						on International Oilfield Supplies - Piping The World. All
						intellectual property rights are reserved. You may access this from
						United Piping Solutions - Piping The World for your own personal use
					...
					<ul>
						<li>
							Republish material from International Oilfield Supplies - Piping
							The World
						</li>
						<li>
							Sell, rent or sub-license material from International Oilfield
							Supplies - Piping The World
						</li>
						<li>
							Reproduce, duplicate or copy material from International Oilfield
							Supplies - Piping The World
						</li>
						<li>
							Redistribute content from International Oilfield Supplies - Piping
							The World
						</li>
					</ul>
					...
					<p>
						...
						International Oilfield Supplies LLC does not filter, edit, publish
						or review Comments prior to their presence on the website. Comments
						do not reflect the views and opinions of International Oilfield
						Supplies LLC,its agents and/or affiliates. Comments reflect the
						views and opinions of the person who post their views and opinions.
						To the extent permitted by applicable laws, International Oilfield
						Supplies LLC shall not be liable for the Comments or for any
					...
					<p>
						International Oilfield Supplies LLC reserves the right to monitor
					...
					<p>
						You hereby grant International Oilfield Supplies LLC a non-exclusive
					...
					<p>
						...
						sending an e-mail to International Oilfield Supplies LLC. Please
					...
					<p>
						No use of International Oilfield Supplies LLC's logo or other
