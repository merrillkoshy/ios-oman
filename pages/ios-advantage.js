...
const UpsAdvantage = () => {
	return (
		<>
			<PageBanner pageTitle="The IOS Advantage" />
			...
			<div className="features-details-area ptb-80">
				<div className="container">
					<div className="row align-items-center justify-content-center">
						...
						<p>
							We at IOS are bringing complete transparency to the Piping Value
							Chain by helping the customer and the manufacturer work seamlessly
							and in the process IOS will either eliminate or absorb the factors
					...
					<div className="row align-items-center">
						<div className="col mt-3 features-details">
							<div className="features-details-desc">
								<h3>How IOS will achieve this?</h3>
								<p>
									The backbone and the core strength of IOS is its team of
									...
									in Energy Sector. This has equipped IOS with the
								...
								<p>
									We at IOS are experts in the sourcing and supplying of
